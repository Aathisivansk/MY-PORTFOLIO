  ...
  return (
    <footer className="fixed bottom-2 left-1/2 -translate-x-1/2 w-[98%] max-w-7xl h-14 bg-black/30 backdrop-blur-xl border border-white/20 rounded-lg flex items-center justify-between px-3 z-50 shadow-lg">
      ...
      <div className="flex items-center gap-4">
        <LiveClock />
        <div className="h-8 w-px bg-white/20" />
        <a href="https://github.com/Aathisivansk" target="_blank" rel="noopener noreferrer" className="text-foreground/80 hover:text-primary transition-colors">
          <Github className="w-6 h-6" />
        </a>
        <a href="https://www.linkedin.com/in/aathisivansk/" target="_blank" rel="noopener noreferrer" className="text-foreground/80 hover:text-primary transition-colors">
